...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="app-assets/images/ico/favicon.webp">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="accountFirstName"
                                                name="companyName" placeholder="John"
                                                value="<?php echo $arr['companyName'];?>"
                                                data-msg="Please enter first name" />
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountEmail">Email</label>
                                            <input type="email" class="form-control" id="accountEmail" name="email"
                                                placeholder="Email" value="<?php echo $arr['email'];?>" />
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountLastName">GST No</label>
                                            <input type="text" class="form-control" id="accountLastName" name="GST"
                                                placeholder="Doe" value="<?php echo $arr['GST'];?>"
                                                data-msg="Please enter last name" />
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountOrganization">CIN</label>
                                            <input type="text" class="form-control" id="accountOrganization" name="CIN"
                                                placeholder="Organization name" value="<?php echo $arr['CIN'];?>" />
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountPhoneNumber">Phone Number</label>
                                            <input type="text" class="form-control account-number-mask"
                                                id="accountPhoneNumber" name="phoneNumber" placeholder="Phone Number"
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="accountAddress" name="address"
                                                value="<?php echo $arr['address'];?>" placeholder="Your Address" />
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary mt-1 me-1" name="submit">Save
                                                changes</button>
                                        </div>
                                    </div>
                                    <?php   } ?>
