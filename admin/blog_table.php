        ...
        Add 
            ...
            <tbody>
                        ...
                        ?>
                                        ...
                                        <td><?php echo $arr['blog_content'];?> </td>
                                        <td> <?php
                                                $status=$arr['status'];
                                                if($status=='1'){
                                                    echo '<span class="badge badge-light-primary">PUBLISH</span>';
                                                }
                                               
                                                else if($status=='0'){
                                                    echo '<span class="badge badge-light-danger">DRAFT</span>';
                                                }
                                                ?>     </td>
                                    ...
                                    <a href="blog_table.php?delid=<?php echo $arr['id']; ?>"><button type="button" class="btn btn-outline-primary"><i data-feather="trash"></i></button></a>
                ...
                <!--/ Edit User Modal -->
                    ...
                    <div class="modal fade" id="addNewCard" tabindex="-1" aria-labelledby="addNewCardTitle" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75" action="blog_modal.php" method="post" enctype="multipart/form-data">
