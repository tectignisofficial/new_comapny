...
<head>
	...
	<title>Tectignis - Software Development</title>
				...
				<div class="row mb-70">
					...
					<div class="col-lg-6 mb-30">
						<div class="applicant-img">
							<img src="assets/img/softwaredevelopment.jpg" alt="dashkit">
						</div>
					</div>
				</div>
				<div class="row mt-30">
					...
					<div class="col-lg-6 mb-30 order-lg-first order-last">
						<div class="applicant-img applicant-img-2">
							<img src="assets/img/softwaredevelopment1.jpg" alt="dashkit">
						</div>
					</div>
					<!-- Content -->
					<div class="col-lg-6 align-self-center mb-30">
